...
export const convertUnknownAccountToTypedAccount = (
  ...
  if (unknownAccount instanceof cosmosclient.proto.cosmos.auth.v1beta1.BaseAccount) {
    ...
    unknownAccount instanceof cosmosclient.proto.cosmos.vesting.v1beta1.BaseVestingAccount
  ) {
    return unknownAccount;
  } else if (
    unknownAccount instanceof cosmosclient.proto.cosmos.vesting.v1beta1.ContinuousVestingAccount
  ) {
    return unknownAccount;
  } else if (
    unknownAccount instanceof cosmosclient.proto.cosmos.vesting.v1beta1.DelayedVestingAccount
  ) {
    return unknownAccount;
  } else if (
    unknownAccount instanceof cosmosclient.proto.cosmos.vesting.v1beta1.PeriodicVestingAccount
  ) {
    return unknownAccount;
  } else if (
    unknownAccount instanceof cosmosclient.proto.cosmos.vesting.v1beta1.PermanentLockedAccount
  ) {
    return unknownAccount;
