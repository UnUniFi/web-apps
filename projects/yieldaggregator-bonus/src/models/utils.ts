import { ChainWalletBase, type ChainWalletContext, WalletStatus } from '@cosmos-kit/core';
...
export function getChainWalletContext(
	...
	return {
		...
		getSigningStargateClient: () =>
			walletAssert(wallet?.getSigningStargateClient, [], 'getSigningStargateClient'),
		getSigningCosmWasmClient: () =>
			walletAssert(wallet?.getSigningCosmWasmClient, [], 'getSigningCosmWasmClient'),
		...
		signAndBroadcast: (...params: Parameters<ChainWalletContext['signAndBroadcast']>) =>
		...
		enable: () =>
			clientMethodAssert(wallet?.client?.enable?.bind(wallet.client), [chainId], 'enable'),
		...
		getAccount: () =>
			clientMethodAssert(wallet?.client?.getAccount?.bind(wallet.client), [chainId], 'getAccount'),
		getOfflineSigner: () =>
			clientMethodAssert(
