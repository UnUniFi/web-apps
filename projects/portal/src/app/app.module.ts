...
import { AppCreateTokenFormDialogModule } from './pages/dialogs/incentive/create-token-form-dialog/create-token-form-dialog.module';
...
@NgModule({
  ...
  imports: [
    ...
    AppCreateTokenFormDialogModule,
    GraphQLModule,
  ],
  providers: [],
