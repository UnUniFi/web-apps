...
const srcMarketplaceConfigFilePath = `projects/marketplace/editions/ununifi/launch/${versionName}/firebase-hosting/config.js`;
...
fs.copyFileSync(srcMarketplaceConfigFilePath, "dist/landing-page/marketplace/assets/config.js");
