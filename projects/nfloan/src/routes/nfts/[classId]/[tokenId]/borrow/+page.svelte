  ...
  <div class="flex flex-col lg:flex-row mb-4">
    ...
    <div class="card bg-base-100 shadow-xl w-full xl:w-auto mb-4">
      <div class="card-body">
        ...
        <form #autoFormRef="ngForm" (submit)="onSubmit()" *ngIf="autoBorrow">
          <div class="form-control">
              ...
              <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                  ...
                  <p class="py-4">
                    ...
                    NFT will be liquidated, but if there are other available bids, refinancing will
                    be carried out.
                  </p>
            ...
            <label class="input-group">
              ...
              <input
                ...
                pattern="^[0-9]*\.?[0-9]{0,6}$"
                (change)="onChangeBorrowAmount()"
              />
              <span>{ listingInfo?.bid_denom | coinDenom | async }</span>
            </label>
            <label class="label">
              <span class="label-text-alt">
                Max { borrowAmount } { listingInfo?.bid_denom | coinDenom | async }
              </span>
            </label>
          </div>
        ...
        <form #manualFormRef="ngForm" (submit)="onSubmit()" *ngIf="!autoBorrow">
          <div class="form-control">
