...
export const txParseProposalContent = (
  message: InlineResponse200Accounts,
...
export const txParseMsg = (message: InlineResponse200Accounts): txTitle => {
  ...
  //staking module
  if (instance instanceof cosmosclient.proto.cosmos.staking.v1beta1.MsgEditValidator)
    return parseMsgEditValidator(instance);
  if (instance instanceof cosmosclient.proto.cosmos.staking.v1beta1.MsgCreateValidator)
    return parseMsgCreateValidator(instance);
  if (instance instanceof cosmosclient.proto.cosmos.staking.v1beta1.MsgUndelegate)
    return parseMsgUndelegate(instance);
  if (instance instanceof cosmosclient.proto.cosmos.staking.v1beta1.MsgBeginRedelegate)
    return parseMsgBeginRedelegate(instance);
  if (instance instanceof cosmosclient.proto.cosmos.staking.v1beta1.MsgDelegate)
    return parseMsgDelegate(instance);
  //gov module
  if (instance instanceof cosmosclient.proto.cosmos.gov.v1beta1.MsgSubmitProposal)
    return parseMsgSubmitProposal(instance);
  if (instance instanceof cosmosclient.proto.cosmos.gov.v1.MsgVoteWeighted)
    return parseMsgVoteWeighted(instance);
  if (instance instanceof cosmosclient.proto.cosmos.gov.v1.MsgVote) return parseMsgVote(instance);
  if (instance instanceof cosmosclient.proto.cosmos.gov.v1.MsgDeposit)
    return parseMsgDeposit(instance);
  //distribution module
  if (instance instanceof cosmosclient.proto.cosmos.distribution.v1beta1.MsgFundCommunityPool)
    return parseMsgFundCommunityPool(instance);
  if (instance instanceof cosmosclient.proto.cosmos.distribution.v1beta1.MsgSetWithdrawAddress)
    return parseMsgSetWithdrawAddress(instance);
  if (instance instanceof cosmosclient.proto.cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward)
    return parseMsgWithdrawDelegatorReward(instance);
  if (
    instance instanceof
    cosmosclient.proto.cosmos.distribution.v1beta1.MsgWithdrawValidatorCommission
  )
    return parseMsgWithdrawValidatorCommission(instance);
  //vesting module
  if (instance instanceof cosmosclient.proto.cosmos.vesting.v1beta1.MsgCreateVestingAccount)
    return parseMsgCreateVestingAccount(instance);
  //bank module
  if (instance instanceof cosmosclient.proto.cosmos.bank.v1beta1.MsgSend)
    return parseMsgSend(instance);
...
const parseMsgDelegate = (
  instance: cosmosclient.proto.cosmos.staking.v1beta1.MsgDelegate,
): txTitle => {
...
const parseMsgEditValidator = (
  instance: cosmosclient.proto.cosmos.staking.v1beta1.MsgEditValidator,
): txTitle => {
...
const parseMsgCreateValidator = (
  instance: cosmosclient.proto.cosmos.staking.v1beta1.MsgCreateValidator,
): txTitle => {
...
const parseMsgUndelegate = (
  instance: cosmosclient.proto.cosmos.staking.v1beta1.MsgUndelegate,
): txTitle => {
  const denomAmount = instance.amount?.amount || '';
  const denom = instance.amount?.denom;
  const amount = denomAmount + ' ' + denom;
...
const parseMsgBeginRedelegate = (
  instance: cosmosclient.proto.cosmos.staking.v1beta1.MsgBeginRedelegate,
): txTitle => {
  const denomAmount = instance.amount?.amount || '';
  const denom = instance.amount?.denom;
  return {
...
const parseMsgSubmitProposal = (
  instance: cosmosclient.proto.cosmos.gov.v1beta1.MsgSubmitProposal,
): txTitle => {
...
const parseMsgFundCommunityPool = (
  instance: cosmosclient.proto.cosmos.distribution.v1beta1.MsgFundCommunityPool,
): txTitle => {
  const denomAmount = instance.amount?.[0].amount || '';
  const denom = instance.amount?.[0].denom;
  const amount = denomAmount + ' ' + denom;
...
const parseMsgSetWithdrawAddress = (
  instance: cosmosclient.proto.cosmos.distribution.v1beta1.MsgSetWithdrawAddress,
): txTitle => {
  return {
    txType: instance.constructor.name,
    fromAddress: instance.delegator_address,
...
const parseMsgWithdrawDelegatorReward = (
  instance: cosmosclient.proto.cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward,
): txTitle => {
  return {
    txType: instance.constructor.name,
    fromAddress: instance.delegator_address,
...
const parseMsgWithdrawValidatorCommission = (
  instance: cosmosclient.proto.cosmos.distribution.v1beta1.MsgWithdrawValidatorCommission,
): txTitle => {
  return {
    txType: instance.constructor.name,
    fromAddress: instance.validator_address,
...
const parseMsgCreateVestingAccount = (
  instance: cosmosclient.proto.cosmos.vesting.v1beta1.MsgCreateVestingAccount,
): txTitle => {
  const denomAmount = instance.amount?.[0].amount || '';
  const denom = instance.amount?.[0].denom;
  const amount = denomAmount + ' ' + denom;
