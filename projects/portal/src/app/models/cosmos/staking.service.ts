...
export class StakingService {
  ...
  async buildWithdrawDelegatorRewardTxBuilder(
    ...
    const fromAddress = cosmosclient.AccAddress.fromPublicKey(cosmosPublicKey);
    const msgWithdrawDelegatorReward = this.buildMsgWithdrawDelegatorReward(fromAddress.toString(), validatorAddress);
  ...
  buildMsgWithdrawDelegatorReward(
    ...
    const msgWithdrawDelegatorReward = new proto.cosmos.distribution.v1beta1.MsgWithdrawDelegatorReward({
      delegator_address: delegatorAddress,
      validator_address: validatorAddress,
    });
